...
function App() {
  ...
  const items=[{ id:1 , name:"apple" ,cal:34},
    ...
    const items1=[{ id:1 , name:"Tomoto" ,cal:34},
             {id:2 , name:"LadyFinger" ,cal:89},
             {id:7 , name:"Potato" ,cal:78},
             {id:5 , name:"ghobi" ,cal:45},
             {id:6 , name:"Palak" ,cal:50}
            ];
  // //Sorting function
  ...
  return (
    <>
    {/* {items.lenght > 0 ?  <List valu={items} cat="fruits"/> : null}
    
    {items1.lenght > 0 ? <List valu={items1} cat="vegitable"/> : null} */}
   <List valu={items} cat="fruits"/>
   <List valu={items1} cat="vegitable"/>
    </>
  );
}
